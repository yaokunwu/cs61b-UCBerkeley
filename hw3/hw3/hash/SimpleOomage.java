...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        SimpleOomage compared = (SimpleOomage) o;
        if (compared.red == this.red && compared.green == this.green
                && compared.blue == this.blue) {
            return true;
        }
        return false;
    }
...
//       test.
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            double h = red / 5 * Math.pow(51.0, 2) + green / 5 * Math.pow(51.0, 1)
                    + blue / 5 * Math.pow(51.0, 0);
            return (int) h;
        }
    }
